...
class _CategoryViewState extends State<CategoryView> {
  ...
  Widget build(BuildContext context) {
    ...
    final double btnUp = Provider.of<ValuesNotifier>(context, listen: true).btnUp;
    ...
    return GestureDetector(
        ...
        child: Scaffold(
            ...
            body: SafeArea(
              child: categoryProducts == null || (categoryProducts != null && (categoryProducts!.totalCount ?? 0) == 0) ? SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    if (categoryProducts != null && categoryProducts?.filters != null && categoryProducts!.filters!.isNotEmpty) Container(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          children: List<Widget>.generate(categories.length, (index) {
                            ...
                            if (item.id == widget.category.id && keys[index].currentContext != null && !Provider.of<ValuesNotifier>(context, listen: false).scroll) {
                              WidgetsBinding.instance.addPostFrameCallback((_) {
                                Provider.of<ValuesNotifier>(context, listen: false).setScroll();
                            ...
                            return GestureDetector(
                                key: keys[index],
                                onTap: () async {
                                  Provider.of<ValuesNotifier>(context, listen: false).setBtnUp(0);
                ...
                children: [
                  NotificationListener<ScrollNotification>(
                      onNotification: (scrollNotification) {
                        final x = scrollController.position.pixels;

                        if (x > 120 && scrollController.position.userScrollDirection == ScrollDirection.reverse && btnUp == 1) {
                          Provider.of<ValuesNotifier>(context, listen: false).setBtnUp(0);
                        } else if (scrollController.position.userScrollDirection == ScrollDirection.forward && btnUp == 0) {
                          Provider.of<ValuesNotifier>(context, listen: false).setBtnUp(1);
                        }
                      ...
                      child: CustomScrollView(
                          ...
                          slivers: [
                            SliverAppBar(
                              ...
                              backgroundColor: const Color(0xFFEBF3FB),
                              titleSpacing: 0,
                              expandedHeight: 114 + (categoryProducts != null && categoryProducts?.filters != null && categoryProducts!.filters!.isNotEmpty ? 42 : 0),
                              floating: true,
                                          ...
                                          child: Row(
                                            children: List<Widget>.generate(categories.length, (index) {
                                              ...
                                              return GestureDetector(
                                                  ...
                                                  child: Container(
                                                    height: 29,
                                                    padding: const EdgeInsets.only(left: 20, right: 30, top: 2, bottom: 5),
                                                    margin: const EdgeInsets.only(left: 0, right: 10),
                                                    decoration: ShapeDecoration(
                                                      color: Color(item.id == widget.category.id ? 0xFF23262C : 0xFFEBF3FB),
                                                      shape: RoundedRectangleBorder(
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                          ...
                          child: CircleAvatar(
                            radius: 25,
                            backgroundColor: const Color(0xFF12B438),
                            child: SvgPicture.asset("assets/upb.svg", semanticsLabel: 'up', width: 25, height: 25),
                          )
                      ),
                    )
                  )
